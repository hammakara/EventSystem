                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <label class="flex items-center">
                                    <input
                                        ...
                                        name="status"
                                        value="active"
                                        class="shrink-0 mt-1 border-gray-300 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                        {{ old('status', $event->status) == 'active' ? 'checked' : '' }}
                                        required
                                    >
                                ...
                                <label class="flex items-center">
                                    <input
                                        ...
                                        value="inactive"
                                        class="shrink-0 mt-1 border-gray-300 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                        {{ old('status', $event->status) == 'inactive' ? 'checked' : '' }}
                                    >
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if($event->image)
                                <div class="mb-3">
                                    <img src="{{ Storage::url($event->image) }}" alt="Current event image" class="w-32 h-32 object-cover rounded-lg border border-gray-200 dark:border-neutral-700">
                                    <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">Current image. Upload a new one to replace.</p>
                                </div>
                            @endif
                            <input
                                type="file"
