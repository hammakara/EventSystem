<x-layouts.dashboard title="Create venue">
    <div class="p-6 max-w-2xl">
        <form method="POST" action="{{ route('venues.store') }}" enctype="multipart/form-data" class="space-y-4" x-data="{ preview:null }">
            @csrf
            <div>
            ...
            <div>
                ...
                <input name="address" value="{{ old('address') }}" class="form-control" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input name="owner" value="{{ old('owner') }}" class="form-control">
            </div>
            <div>
