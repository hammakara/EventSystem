<x-layouts.dashboard title="Create Role">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="mt-1 block w-full rounded-lg border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 focus:border-violet-500 focus:ring-violet-500 @error('name') border-red-500 @enderror">
                        @error('name')
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Usually 'web' for web applications</p>
                        @error('guard_name')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
